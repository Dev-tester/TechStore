...
<tr>
	...
	<td width="60%">
		<label>
			<input type="radio" name="operation" value="copy" <?php if ($arCurrentValues['operation'] != 'move') echo 'checked'?>><?= GetMessage("BPDCM_PD_OPERATION_COPY") ?>
		</label>
		<br/>
		<label>
			<input type="radio" name="operation" value="move" <?php if ($arCurrentValues['operation'] == 'move') echo 'checked'?>><?= GetMessage("BPDCM_PD_OPERATION_MOVE") ?>
		</label>
	</td>
</tr>
<tr>
	...
	<td width="60%">
		<select name="entity_type" onchange="BPDUA_changeEntityType(this.value);">
			<option value="user" <?php if ($arCurrentValues['entity_type'] == 'user') echo 'selected'?>><?=GetMessage('BPDCM_PD_ENTITY_TYPE_USER')?></option>
			<?php  if (CModule::IncludeModule('socialnetwork')):?>
			<option value="sg" <?php if ($arCurrentValues['entity_type'] == 'sg') echo 'selected'?>><?=GetMessage('BPDCM_PD_ENTITY_TYPE_SG')?></option>
			<?php endif?>
			<option value="common" <?php if ($arCurrentValues['entity_type'] == 'common') echo 'selected'?>><?=GetMessage('BPDCM_PD_ENTITY_TYPE_COMMON')?></option>
			<option value="folder" <?php if ($arCurrentValues['entity_type'] == 'folder') echo 'selected'?>><?=GetMessage('BPDCM_PD_ENTITY_TYPE_FOLDER_1')?></option>
		</select>
	</td>
</tr>
