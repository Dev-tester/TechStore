		...
		<tr>
			...
			<td>
				...
				<tr>
					...
					<td><p><label for="news"><?php echo GetMessage("IBLOCK_INSTALL_NEWS")?></label></p></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td><p><?php echo GetMessage("IBLOCK_INSTALL_PUBLIC_DIR")?>:<input type="text" name="news_dir" value="news" size="20" id="public_dir_n"></p></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td><p><label for="catalog"><?php echo GetMessage("IBLOCK_INSTALL_CATALOG")?></label></p></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td><p><?php echo GetMessage("IBLOCK_INSTALL_PUBLIC_DIR")?>:<input type="text"  name="catalog_dir" value="catalog" size="20" id="public_dir_c"></p></td></tr>
				<tr>
					<td>&nbsp;</td>
