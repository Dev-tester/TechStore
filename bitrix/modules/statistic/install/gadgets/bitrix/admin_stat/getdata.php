...
if($_REQUEST["table_id"] == "adv"):
	...
	<tbody>
	<tr>
		<th><?php echo GetMessage("GD_STAT_ADV_NAME")?></th>
		<th><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/session_list.php", array(
				'lang' => $_REQUEST["lang"],
				'find_date1' => $now_date,
				'find_date2' => $now_date,
				'find_adv_back' => 'N',
	...
	while ($arAdv = $rsAdv->GetNext()):
		?><tr>
			<td>[<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/adv_list.php", array(
				'lang' => $_REQUEST["lang"],
				'find_id' => $arAdv["ID"],
			...
			<td align="right"><?php 
				if (intval($arAdv["SESSIONS_TODAY"]) > 0):
					?><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/session_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_date1' => $now_date,
						'find_date2' => $now_date,
						...
						'find_adv_back' => 'N',
						'set_filter' => 'Y',
					), array("encode" => true)))?>"><?=$arAdv["SESSIONS_TODAY"]?></a><?php 
				else:
					?>&nbsp;<?php 
				endif;
			?></td>
			<td align="right"><?php 
				if (intval($arAdv["SESSIONS_YESTERDAY"])>0):
					?><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/session_list.php", array(
						...
						'find_adv_back' => 'N',
						'set_filter' => 'Y',
					), array("encode" => true)))?>"><?=$arAdv["SESSIONS_YESTERDAY"]?></a><?php 
				else:
					?>&nbsp;<?php 
				endif;
			?></td>
			<td align="right"><?php 
				if (intval($arAdv["SESSIONS_BEF_YESTERDAY"])>0):
					?><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/session_list.php", array(
						...
						'find_adv_back' => 'N',
						'set_filter' => 'Y',
					), array("encode" => true)))?>"><?=$arAdv["SESSIONS_BEF_YESTERDAY"]?></a><?php 
				else:
					?>&nbsp;<?php 
				endif;
			?></td>
			<td align="right"><?php 
				if (intval($arAdv["SESSIONS"])>0):
					?><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/session_list.php", array(
						...
						'find_adv_back' => 'N',
						'set_filter' => 'Y',
					), array("encode" => true)))?>"><?=$arAdv["SESSIONS"]?></a><?php 
				else:
					?>&nbsp;<?php 
				endif;
			?></td>
	...
	if (!$bFound):
		?><tr><td align="center" colspan="5"><?=GetMessage("GD_STAT_NO_DATA")?></td></tr><?php 
	endif;
...
elseif($_REQUEST["table_id"] == "event"):
	...
	<tbody>
	<tr>
		<th><?php echo GetMessage("GD_STAT_EVENT")?></th>
		<th><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/event_list.php", array(
			'lang' => $_REQUEST["lang"],
			'find_date1' => $now_date,
			'find_date2' => $now_date,
			'set_filter' => 'Y',
		...
		?><tr>
			<td><?php 
				...
				if ($dynamic_days >= 2 && function_exists("ImageCreate")):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/event_graph_list.php", array(
						'lang' => $_REQUEST["lang"],
			...
			<td align="right"><?php 
				if (intval($arEvent["TODAY_COUNTER"]) > 0):
					?><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/event_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_date1' => $now_date,
						'find_date2' => $now_date,
						...
						'set_filter' => 'Y',
					), array("encode" => true)))?>"><?=$arEvent["TODAY_COUNTER"]?></a><?php 
				else:
					?>&nbsp;<?php 
				endif;
			?></td>
			<td align="right">
				<?php if (intval($arEvent["YESTERDAY_COUNTER"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/event_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_date1' => $yesterday_date,
						'find_date2' => $yesterday_date,
			...
			<td align="right">
				<?php if (intval($arEvent["B_YESTERDAY_COUNTER"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/event_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_date1' => $bef_yesterday_date,
						'find_date2' => $bef_yesterday_date,
			...
			<td align="right">
				<?php if (intval($arEvent["TOTAL_COUNTER"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/event_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_event_id' => $arEvent["ID"],
						'find_event_id_exact_match' => 'Y',
...
elseif($_REQUEST["table_id"] == "referer"):
	...
	<tr>
		...
		<th><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/referer_list.php", array(
			'lang' => $_REQUEST["lang"],
	...
	while ($arReferer = $rsReferers->GetNext()):
		?><tr>
			<td><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/referer_list.php", array(
				'lang' => $_REQUEST["lang"],
				'find_site_id' => $_REQUEST["site_id"],
			...
			<td align="center">
				<?php if(intval($arReferer["TODAY_REFERERS"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/referer_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_date1' => $now_date,
						'find_date2' => $now_date,
			...
			<td align="center">
				<?php if(intval($arReferer["YESTERDAY_REFERERS"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/referer_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_date1' => $yesterday_date,
			...
			<td align="center">
				<?php if(intval($arReferer["B_YESTERDAY_REFERERS"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/referer_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_date1' => $bef_yesterday_date,
			...
			<td align="center">
				<?php if(intval($arReferer["TOTAL_REFERERS"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/referer_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_from' => "\"".$arReferer["SITE_NAME"]."\"",
...
elseif($_REQUEST["table_id"] == "phrase"):
	...
	<tr>
		...
		<th><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/phrase_list.php", array(
			'lang' => $_REQUEST["lang"],
			'find_site_id' => $_REQUEST["site_id"],
			'find_date1' => $now_date,
			'find_date2' => $now_date,
	...
	while ($arPhrase = $rsPhrases->Fetch()):
		?><tr>
			<td><a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/phrase_list.php", array(
				'lang' => $_REQUEST["lang"],
				'find_site_id' => $_REQUEST["site_id"],
				...
				'menu_item_id' => 1,
				'set_filter' => 'Y',
			), array("encode" => true, "skip_empty" => true)))?>"><?php echo htmlspecialcharsbx(TruncateText($arPhrase["PHRASE"], 50))?></a>&nbsp;</td>
			<td align="center">
				<?php if(intval($arReferer["TODAY_PHRASES"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/phrase_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_date1' => $now_date,
						'find_date2' => $now_date,
			...
			<td align="center">
				<?php if(intval($arReferer["YESTERDAY_PHRASES"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/phrase_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_date1' => $yesterday_date,
			...
			<td align="center">
				<?php if(intval($arReferer["B_YESTERDAY_PHRASES"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/phrase_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_date1' => $bef_yesterday_date,
			...
			<td align="center">
				<?php if(intval($arReferer["TOTAL_PHRASES"]) > 0):?>
					<a href="<?php echo htmlspecialcharsbx(CHTTP::urlAddParams("/bitrix/admin/phrase_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_phrase' => htmlspecialcharsback($arPhrase["PHRASE"]),
