...
$MESS["CACHE_FOR_ADMIN_TIP"] = "Caching is disabled for the Administrators user group by default which entails database queries to be performed whenever data is required. Disable this option to decrease database load.";
?>