...
<?php if($arResult["bDescPageNumbering"] === true):?>
	...
	<?php if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		<?php if($arResult["bSavePage"]):?>
			<li class="bx-pag-prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><span><?php echo GetMessage("round_nav_back")?></span></a></li>
		...
		<?php else:?>
			<?php if (($arResult["NavPageNomer"]+1) == $arResult["NavPageCount"]):?>
				<li class="bx-pag-prev"><a href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><span><?php echo GetMessage("round_nav_back")?></span></a></li>
			<?php else:?>
				<li class="bx-pag-prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><span><?php echo GetMessage("round_nav_back")?></span></a></li>
			<?php endif?>
	...
	<?php if ($arResult["NavPageNomer"] > 1):?>
		...
		<?php endif?>
			<li class="bx-pag-next"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><span><?php echo GetMessage("round_nav_forward")?></span></a></li>
	<?php else:?>
		<?php if($arResult["NavPageCount"] > 1):?>
...
<?php if ($arResult["bShowAll"]):?>
	<?php if ($arResult["NavShowAll"]):?>
			<li class="bx-pag-all"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>SHOWALL_<?=$arResult["NavNum"]?>=0" rel="nofollow"><span><?php echo GetMessage("round_nav_pages")?></span></a></li>
	<?php else:?>
			<li class="bx-pag-all"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>SHOWALL_<?=$arResult["NavNum"]?>=1" rel="nofollow"><span><?php echo GetMessage("round_nav_all")?></span></a></li>
	<?php endif?>
<?php endif?>
		</ul>
