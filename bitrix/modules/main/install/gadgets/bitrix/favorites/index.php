...
?>
		...
		<a class="gdfavdellink" href="javascript:void(0)" onclick="return Del<?=$rnd?>('<?=$i?>')"><?php echo GetMessage("GD_FAVORITES_DEL")?></a><br>
	</div>
<?php endforeach?>
</div>

<div id="gdfavoriteslink<?=$rnd?>" class="gdfavaddlink"><a href="javascript:void(0)" onclick="return ShowHide<?=$rnd?>(true);"><?php echo GetMessage("GD_FAVORITES_ADD")?></a>
| <a href="javascript:void(0)" onclick="return EditMode<?=$rnd?>(true);"><?php echo GetMessage("GD_FAVORITES_CH")?></a>
</div>

<div id="gdfavoriteslink2<?=$rnd?>" style="display: none;" class="gdfavaddlink"><a href="javascript:void(0)" onclick="return EditMode<?=$rnd?>(false);"><?php echo GetMessage("GD_FAVORITES_CH_EXIT")?></a> </div>
...
<form action="<?=$arParams["UPD_URL"]?>" method="post">
	...
	<table cellpadding="0" cellspacing="0" border="0"  class="gdfvaddtable">
		<tr><td colspan="2" class="gdfvaddheader"><?php echo GetMessage("GD_FAVORITES_NEW_URL")?></td></tr>
		<tr><td class="gdfvaddleft"><?php echo GetMessage("GD_FAVORITES_URL")?></td><td class="gdfvaddright"><input type="text" value="http://" name="url"></td></tr>
		<tr><td class="gdfvaddleft"><?php echo GetMessage("GD_FAVORITES_NAME")?></td><td class="gdfvaddright"><input type="text" name="name"></td></tr>
		<tr><td class="gdfvaddleft">&nbsp;</td><td class="gdfvaddright"><input type="submit" name="gdfvadd" value="<?php echo GetMessage("GD_FAVORITES_ADD_URL")?>"><input type="button" value="<?php echo GetMessage("GD_FAVORITES_CANCEL_URL")?>" onclick="ShowHide<?=$rnd?>(false);"></td></tr>
	</table>
</form>
</div>
<?php 
