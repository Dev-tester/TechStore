...
<?php $oFilter->Begin();?>
	<tr>
		<td><?php echo GetMessage("RATING_RULE_LIST_FLT_NAME")?></td>
		<td><input type="text" name="find_name" size="40" value="<?php echo htmlspecialcharsbx($find_name)?>"><?=ShowFilterLogicHelp()?></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("RATING_RULE_LIST_FLT_ACTIVE")?></td>
		<td><select name="find_active">
			<option value=""><?php echo GetMessage("RATING_RULE_LIST_FLT_ALL")?></option>
			<option value="Y"<?php if($find_active == "Y") echo " selected"?>><?php echo GetMessage("RATING_RULE_LIST_FLT_ACTIVE_Y")?></option>
			<option value="N"<?php if($find_active == "N") echo " selected"?>><?php echo GetMessage("RATING_RULE_LIST_FLT_ACTIVE_N")?></option>
			</select>
		</td>
	</tr>
	<tr>
		<td><?php echo GetMessage("RATING_RULE_LIST_FLT_ID")?></td>
		<td><input type="text" name="find_id" size="13" value="<?php echo htmlspecialcharsbx($find_id)?>"></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("RATING_RULE_LIST_FLT_ENTITY_TYPE_ID")?></td>
		<td><input type="text" name="find_entity_type_id" value="<?php echo htmlspecialcharsbx($find_entity_type_id)?>" size="40"><?=ShowFilterLogicHelp()?></td>
	</tr>
<?php 
