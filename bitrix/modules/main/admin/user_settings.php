...
?>
<form method="POST" name="form1" action="<?php echo $APPLICATION->GetCurPage()?>">
<?=bitrix_sessid_post()?>
...
?>
	<tr class="heading">
		<td colspan="2"><?php echo GetMessage("user_sett_personal")?></td>
	</tr>
	<tr>
		<td width="40%"><?php echo GetMessage("user_sett_context")?></td>
	...
	<tr>
		<td class="adm-detail-valign-top"><?php echo GetMessage("user_sett_context_ctrl")?></td>
		<td>
			<input type="radio" name="context_ctrl" id="context_ctrl_N" value="N"<?php if($aUserOpt["context_ctrl"] <> "Y") echo " checked"?><?php if($aUserOpt["context_menu"] <> "Y") echo " disabled"?>><label for="context_ctrl_N"><?php echo GetMessage("user_sett_context_ctrl_val1")?></label><br>
			<input type="radio" name="context_ctrl" id="context_ctrl_Y" value="Y"<?php if($aUserOpt["context_ctrl"] == "Y") echo " checked"?><?php if($aUserOpt["context_menu"] <> "Y") echo " disabled"?>><label for="context_ctrl_Y"><?php echo GetMessage("user_sett_context_ctrl_val2")?></label><br>
		</td>
	</tr>
	<tr>
		<td><?php echo GetMessage("user_sett_autosave")?></td>
		<td><input type="checkbox" name="autosave" value="Y"<?php if($aUserOpt["autosave"] == "Y") echo " checked=\"checked\""?> /></td>
	</tr>
	<tr class="heading">
		<td colspan="2"><?php echo GetMessage("user_sett_panel")?></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("MAIN_OPTION_DYN_EDIT")?></td>
		<td><input type="checkbox" name="panel_dynamic_mode" value="Y"<?php if($aUserOpt["panel_dynamic_mode"] == "Y") echo " checked"?>></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("MAIN_OPTION_PAGE_EDIT_ENABLE")?></td>
		<td><input type="checkbox" name="page_edit_control_enable" value="Y"<?php if($aUserOpt["page_edit_control_enable"] != "N") echo " checked"?>></td>
	</tr>
	<tr class="heading">
		<td colspan="2"><?php echo GetMessage("user_sett_start")?></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("user_sett_start_preload")?></td>
		<td><input type="checkbox" name="start_menu_preload" value="Y"<?php if($aUserOpt["start_menu_preload"] == "Y") echo " checked"?>></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("user_sett_titles")?></td>
		<td><input type="checkbox" name="start_menu_title" value="Y"<?php if($aUserOpt["start_menu_title"] == "Y") echo " checked"?>></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("user_sett_start_links")?></td>
		<td>
			<input type="text" name="start_menu_links" value="<?php echo htmlspecialcharsbx($aUserOpt["start_menu_links"])?>" size="10">
			<a href="javascript:if(confirm('<?php echo CUtil::addslashes(GetMessage("user_sett_del_links_conf"))?>'))window.location='user_settings.php?action=clear_links&lang=<?php echo LANG?>&<?php echo bitrix_sessid_get()?>';"><?php echo GetMessage("user_sett_del_links")?></a>
		</td>
	</tr>

	<tr class="heading">
		<td colspan="2"><?php echo GetMessage("user_sett_sounds")?></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("user_sett_sounds_play")?></td>
		<td><input type="checkbox" name="sound" value="Y"<?php if($aUserOpt["sound"] == "Y") echo " checked"?>></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("user_sett_sounds_login")?></td>
		<td>
<?php 
...
?>
			<input type="text" name="sound_login" value="<?php echo htmlspecialcharsbx($aUserOpt["sound_login"])?>" size="40">
			<input type="button" value="..." title="<?php echo GetMessage("user_sett_sounds_button_title")?>" onclick="OpenFileBrowserWindFile()">
		</td>
	</tr>

	<tr class="heading">
		<td colspan="2"><?php echo GetMessage("user_sett_mess_head")?></td>
	</tr>
	<tr>
		<td class="adm-detail-valign-top"><?php echo GetMessage("user_sett_mess")?></td>
		<td>
			<div class="adm-list">
				<div class="adm-list-item">
					...
					<div class="adm-list-label"><label for="messages_support"><?php echo GetMessage("user_sett_mess_support")?></label></div>
				</div>
				...
				<div class="adm-list-item">
					...
					<div class="adm-list-label"><label for="messages_security"><?php echo GetMessage("user_sett_mess_security")?></label></div>
				</div>
				<?php endif;?>
				...
				<div class="adm-list-item">
					...
					<div class="adm-list-label"><label for="messages_perfmon"><?php echo GetMessage("user_sett_mess_perfmon")?></label></div>
				</div>
				<?php endif;?>
			</div>
		</td>
...
<?php if($USER->CanDoOperation('edit_other_settings')):?>
	<tr class="heading">
		<td colspan="2"><?php echo GetMessage("user_sett_common")?></td>
	</tr>
	<tr>
		<td><?php echo GetMessage("user_sett_common_set")?></td>
...
?>
	<tr>
		<td colspan="2"><a href="javascript:if(confirm('<?php echo CUtil::addslashes(GetMessage("user_sett_del_pers_conf"))?>'))window.location='user_settings.php?action=clear&lang=<?php echo LANG?>&<?php echo bitrix_sessid_get()?>&tabControl_active_tab=edit2';"><?php echo GetMessage("user_sett_del_pers1")?></a></td>
	</tr>
<?php if($USER->CanDoOperation('edit_other_settings')):?>
	<tr>
		<td colspan="2"><a href="javascript:if(confirm('<?php echo CUtil::addslashes(GetMessage("user_sett_del_common_conf"))?>'))window.location='user_settings.php?action=clear_all&lang=<?php echo LANG?>&<?php echo bitrix_sessid_get()?>&tabControl_active_tab=edit2';"><?php echo GetMessage("user_sett_del_common1")?></a></td>
	</tr>
	<tr>
		<td colspan="2"><a href="javascript:if(confirm('<?php echo CUtil::addslashes(GetMessage("user_sett_del_user_conf"))?>'))window.location='user_settings.php?action=clear_all_user&lang=<?php echo LANG?>&<?php echo bitrix_sessid_get()?>&tabControl_active_tab=edit2';"><?php echo GetMessage("user_sett_del_user1")?></a></td>
	</tr>
<?php endif;?>
...
$tabControl->Buttons();
?>
<input<?php if(!$editable) echo " disabled"?> type="submit" name="apply" value="<?php echo GetMessage("admin_lib_edit_apply")?>" title="<?php echo GetMessage("admin_lib_edit_apply_title")?>" class="adm-btn-save">
<?php 
$tabControl->End();
