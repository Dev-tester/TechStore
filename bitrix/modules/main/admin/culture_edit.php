	...
	<tr class="adm-detail-required-field">
		...
		<td>
			<select name="" onchange="if(this.value != ''){this.form.FORMAT_NAME.value = this.value;}">
				<option value=""><?php echo Loc::getMessage("culture_edit_other")?></option>
			<?php 
...
?>
	<tr class="heading">
		<td colspan="2"><?php echo Loc::getMessage("main_culture_edit_date_formats")?></td>
	<tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_short_date")?></td>
		<td><input type="text" name="SHORT_DATE_FORMAT" size="20" maxlength="255" value="<?= $cultureField["SHORT_DATE_FORMAT"]?>">
			<?php if($cultureField["SHORT_DATE_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["SHORT_DATE_FORMAT"]))?></td>
	</tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_medium_date")?></td>
		<td><input type="text" name="MEDIUM_DATE_FORMAT" size="20" maxlength="255" value="<?= $cultureField["MEDIUM_DATE_FORMAT"]?>">
			<?php if($cultureField["MEDIUM_DATE_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["MEDIUM_DATE_FORMAT"]))?></td>
	</tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_long_date")?></td>
	...
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_full_date")?></td>
		<td><input type="text" name="FULL_DATE_FORMAT" size="20" maxlength="255" value="<?= $cultureField["FULL_DATE_FORMAT"]?>">
			<?php if($cultureField["FULL_DATE_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["FULL_DATE_FORMAT"]))?></td>
	</tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_day_month")?></td>
		<td><input type="text" name="DAY_MONTH_FORMAT" size="20" maxlength="255" value="<?= $cultureField["DAY_MONTH_FORMAT"]?>">
			<?php if($cultureField["DAY_MONTH_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["DAY_MONTH_FORMAT"]))?></td>
	</tr>
	<tr class="heading">
		<td colspan="2"><?php echo Loc::getMessage("main_culture_edit_time_formats")?></td>
	<tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_short_time")?></td>
		<td><input type="text" name="SHORT_TIME_FORMAT" size="20" maxlength="255" value="<?= $cultureField["SHORT_TIME_FORMAT"]?>">
			<?php if($cultureField["SHORT_TIME_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["SHORT_TIME_FORMAT"]))?></td>
	</tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_long_time")?></td>
		<td><input type="text" name="LONG_TIME_FORMAT" size="20" maxlength="255" value="<?= $cultureField["LONG_TIME_FORMAT"]?>">
			<?php if($cultureField["LONG_TIME_FORMAT"] <> '') echo htmlspecialcharsbx(FormatDate($cultureField["LONG_TIME_FORMAT"]))?></td>
	</tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_am")?></td>
		<td><input type="text" name="AM_VALUE" size="10" maxlength="255" value="<?= $cultureField["AM_VALUE"]?>"></td>
	</tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_edit_pm")?></td>
	...
	<tr>
	<tr class="heading">
		<td colspan="2"><?php echo Loc::getMessage("main_culture_numbers_format")?></td>
	<tr>
	<tr>
		<td><?php echo Loc::getMessage("main_culture_numbers_thousands_sep")?></td>
