...
<?php foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<?php $classPict = '';?>
	<?php if(!$arItem["PROPERTIES"]["PARTMAIN"]["VALUE"] && $showHr): $showHr = false;?><div class="hr"></div><?php endif;?>
	<?php if($arItem["PROPERTIES"]["PARTMAIN"]["VALUE"]): $showHr = true;?><div class="main-news-list"><?php endif;?>
	<div class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']."_".$q);?>">
		...
		<?php if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
			<span class="news-date-time"><?php echo $arItem["DISPLAY_ACTIVE_FROM"]?>  <?php if(count($arItem["FIELDS"]) > 0 || count($arItem["DISPLAY_PROPERTIES"]) > 0 ):?>/<?php endif;?></span>
		<?php endif?>
		...
		<?php if($arParams["DISPLAY_PREVIEW_TEXT"]!="N" && $arItem["PREVIEW_TEXT"]):?>
			<span class="news-preview-text"><?php echo $arItem["PREVIEW_TEXT"];?></span><br/>
		<?php endif;?>
	...
	<?php if($arItem["PROPERTIES"]["PARTMAIN"]["VALUE"]):?></div><?php endif;?>
<?php endforeach;?>
