...
?>
	<li id="<?=$this->GetEditAreaId($arSection['ID']);?>"><a href="<?=$arSection["SECTION_PAGE_URL"]?>"><?=$arSection["NAME"]?></a><?php if($arParams["COUNT_ELEMENTS"]):?><span>&nbsp;(<?=$arSection["ELEMENT_CNT"]?>)</span><?php endif;?></li>
<?php endforeach?>
</ul>
</div>
