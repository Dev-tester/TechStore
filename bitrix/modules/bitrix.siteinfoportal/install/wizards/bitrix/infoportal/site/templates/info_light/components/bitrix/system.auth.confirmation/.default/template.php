...
<div class="field"><?php echo $arResult["MESSAGE_TEXT"]?></div>
...
<?php if($arResult["SHOW_FORM"]):?>
	<form method="post" action="<?php echo $arResult["FORM_ACTION"]?>">
		<div class="field">
			<label class="field-title"><?php echo GetMessage("CT_BSAC_LOGIN")?></label>
			<div class="form-input"><input type="text" name="<?php echo $arParams["LOGIN"]?>" maxlength="50" value="<?php echo (strlen($arResult["LOGIN"]) > 0? $arResult["LOGIN"]: $arResult["USER"]["LOGIN"])?>" size="17" /></div>
		</div>
		<div class="field">
			<label class="field-title"><?php echo GetMessage("CT_BSAC_CONFIRM_CODE")?></label>
			<div class="form-input"><input type="text" name="<?php echo $arParams["CONFIRM_CODE"]?>" maxlength="50" value="<?php echo $arResult["CONFIRM_CODE"]?>" size="17" /></div>
		</div>
		<div class="field field-button"><input type="submit" class="input-submit" value="<?php echo GetMessage("CT_BSAC_CONFIRM")?>" /></div>
