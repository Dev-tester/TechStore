...
<table class="header">
	<tr>
		<?php  if (CSalePaySystemAction::GetParamValue("PATH_TO_LOGO", false)) { ?>
		<td style="padding-right: 5pt; ">
			<?php  $imgParams = CFile::_GetImgParams(CSalePaySystemAction::GetParamValue('PATH_TO_LOGO', false)); ?>
			<?php  $imgWidth = $imgParams['WIDTH'] * 96 / (intval(CSalePaySystemAction::GetParamValue('LOGO_DPI', false)) ?: 96); ?>
			<img src="<?=$imgParams['SRC']; ?>" width="<?=$imgWidth; ?>" />
		</td>
		<?php  } ?>
		<td>
			<b><?=CSalePaySystemAction::GetParamValue("SELLER_NAME", false); ?></b><br>
			<?php  if (CSalePaySystemAction::GetParamValue("SELLER_ADDRESS", false)) { ?>
			<b><?=CSalePaySystemAction::GetParamValue("SELLER_ADDRESS", false); ?></b><br>
			<?php  } ?>
			<?php  if (CSalePaySystemAction::GetParamValue("SELLER_PHONE", false)) { ?>
...
<table width="100%">
	<tr>
		<?php  if (CSalePaySystemAction::GetParamValue("BUYER_NAME", false)) { ?>
		<td>
			<b>Para</b><br>
...
<?php  $bankAccNo = CSalePaySystemAction::GetParamValue("SELLER_BANK_ACCNO", false); ?>
<?php  $bankRouteNo = CSalePaySystemAction::GetParamValue("SELLER_BANK_ROUTENO", false); ?>
<?php  $bankSwift = CSalePaySystemAction::GetParamValue("SELLER_BANK_SWIFT", false); ?>
...
<table class="sign" style="width: 100%; ">
	<tr>
		...
		<?php  if ($bankAccNo && $bankRouteNo && $bankSwift) { ?>
			...
			<?php  if (CSalePaySystemAction::GetParamValue("SELLER_NAME", false)) { ?>
			...
			<?php  $bank = CSalePaySystemAction::GetParamValue("SELLER_BANK", false); ?>
			<?php  $bankAddr = CSalePaySystemAction::GetParamValue("SELLER_BANK_ADDR", false); ?>
			<?php  $bankPhone = CSalePaySystemAction::GetParamValue("SELLER_BANK_PHONE", false); ?>

			<?php  if ($bank || $bankAddr || $bankPhone) { ?>
				Nombre y dirección del banco: <?php  if ($bank) { ?><?=$bank; ?><?php  } ?>
				<br>
		...
		<td style="width: 50%; ">
			...
			<table style="width: 100%; position: relative; ">
				...
				<?php  if (CSalePaySystemAction::GetParamValue("SELLER_DIR_POS", false)) { ?>
				<?php  if (CSalePaySystemAction::GetParamValue("SELLER_DIR", false) || CSalePaySystemAction::GetParamValue("SELLER_DIR_SIGN", false)) { ?>
				<?php  if (CSalePaySystemAction::GetParamValue("SELLER_DIR", false)) { ?>
				<tr><td>&nbsp;</td></tr>
				<tr>
				...
				<tr>
					...
					<td style="border-bottom: 1pt solid #000000; text-align: center; ">
						<?php  if (!$blank && CSalePaySystemAction::GetParamValue("SELLER_DIR_SIGN", false)) { ?>
				...
				<?php  } ?>
				<?php  } ?>
				<?php  if (CSalePaySystemAction::GetParamValue("SELLER_ACC_POS", false)) { ?>
				<?php  if (CSalePaySystemAction::GetParamValue("SELLER_ACC", false) || CSalePaySystemAction::GetParamValue("SELLER_ACC_SIGN", false)) { ?>
				<?php  if (CSalePaySystemAction::GetParamValue("SELLER_ACC", false)) { ?>
				<tr><td>&nbsp;</td></tr>
				<tr>
				...
				<tr>
					...
					<td style="border-bottom: 1pt solid #000000; text-align: center; ">
						<?php  if (!$blank && CSalePaySystemAction::GetParamValue("SELLER_ACC_SIGN", false)) { ?>
						<span style="position: relative; ">&nbsp;<?=CFile::ShowImage(
