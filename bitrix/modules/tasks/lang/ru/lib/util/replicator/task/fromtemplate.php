...
$MESS['TASKS_REPLICATOR_INTERNAL_ERROR'] = 'Внутренняя ошибка. Пожалуйста, обратитесь в техподдержку';
$MESS['TASKS_REPLICATOR_TASK_POSSIBLY_WAS_NOT_CREATED'] = 'Задача по расписанию была создана с ошибками';
$MESS['TASKS_REPLICATOR_CANT_IDENTIFY_USER'] = 'Невозможно определить пользователя, от имени которого выполнять создание задачи. Проверьте активность учетной записи администратора';
...
$MESS['TASKS_REPLICATOR_CREATOR_INACTIVE'] = 'Учетная запись постановщика задачи не существует или не активна';
