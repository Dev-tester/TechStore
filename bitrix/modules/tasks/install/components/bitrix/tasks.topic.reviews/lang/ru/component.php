...
$MESS ['F_NO_MODULE_TASKS'] = "Модуль \"Задачи\" не установлен.";
$MESS ['F_ERR_FID_EMPTY'] = "Не указан форум для отзывов.";
$MESS ['F_ERR_FID_IS_NOT_EXIST'] = "Форум для отзывов #FORUM_ID# не существует.";
$MESS ['F_ERR_TID_EMPTY'] = "Не указана задача.";
$MESS ['F_ERR_TID_IS_NOT_EXIST'] = "Задача #TASK_ID# не найдена.";
...
$MESS ['F_ERR_FORUM_NO_ACCESS'] = "У вас не достаточно прав на просмотр комментариев.";
?>
