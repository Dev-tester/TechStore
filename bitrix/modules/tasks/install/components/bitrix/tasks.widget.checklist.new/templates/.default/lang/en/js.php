...
$MESS["TASKS_CHECKLIST_COMPONENT_JS_CHECKLIST_NOT_CONVERTED_MESSAGE_PART_4"] = "<a href=\"#\" style='text-decoration: underline;' onclick='top.BX.Helper.show(\"redirect=detail&code=1391316\");event.preventDefault();'>Learn more</a> about new checklist.";
$MESS["TASKS_CHECKLIST_COMPONENT_JS_NEW_CHECKLIST_TITLE"] = "Checklist";
?>