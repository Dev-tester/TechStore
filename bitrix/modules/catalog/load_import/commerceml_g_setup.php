...
if ($STEP == 1)
{
	...
	<tr>
		...
		<td valign="top" width="60%">
			...
			<input type="button" value="<?php  echo GetMessage("CML_S_SELECT"); ?>" onclick="cmlBtnSelectClick()">
<?php 
CAdminFileDialog::ShowScript(
	...
	<tr>
		...
		<td valign="top" width="60%"><?php 
			...
			?><input type="radio" name="keepExistingProperties" id="keepExistingProperties_N" value="N" <?php if ($keepExistingProperties=="N") echo "checked";?>> <label for="keepExistingProperties_N"><?php  echo GetMessage("CML_S_NO"); ?></label><br>
			<input type="radio" name="keepExistingProperties" id="keepExistingProperties_Y" value="Y" <?php if ($keepExistingProperties=="Y") echo "checked";?>> <label for="keepExistingProperties_Y"><?php  echo GetMessage("CML_S_YES"); ?></label>
		</td>
	</tr>
	<tr>
		<td valign="top" width="40%"><?php  echo GetMessage("CML_S_KEEP_DATA"); ?>:</td>
		<td valign="top" width="60%"><?php 
			if (!isset($keepExistingData) || ('N' != $keepExistingData && 'Y' != $keepExistingData))
			{
				$keepExistingData = 'Y';
			}
			?><input type="radio" name="keepExistingData" id="keepExistingData_N" value="N" <?php if ($keepExistingData=="N") echo "checked";?>> <label for="keepExistingData_N"><?php  echo GetMessage("CML_S_NO"); ?></label><br>
			<input type="radio" name="keepExistingData" id="keepExistingData_Y" value="Y" <?php if ($keepExistingData=="Y") echo "checked";?>> <label for="keepExistingData_Y"><?php  echo GetMessage("CML_S_YES"); ?></label>
		</td>
	</tr>
	<tr>
		<td valign="top" width="40%"><?php  echo GetMessage("CML_S_ACT_DATA"); ?>:</td>
		<td valign="top" width="60%"><?php 
			if (!isset($activateFileData) || ('N' != $activateFileData && 'Y' != $activateFileData))
			{
				$activateFileData = 'Y';
			}
			?><input type="radio" name="activateFileData" id="activateFileData_Y" value="Y" <?php if ($activateFileData=="Y") echo "checked";?>> <label for="activateFileData_Y"><?php  echo GetMessage("CML_S_YES"); ?></label><br>
			<input type="radio" name="activateFileData" id="activateFileData_N" value="N" <?php if ($activateFileData=="N") echo "checked";?>> <label for="activateFileData_N"><?php  echo GetMessage("CML_S_NO"); ?></label>
		</td>
	</tr>
	<tr>
		<td valign="top" width="40%"><?php  echo GetMessage("CML_S_COMMNT"); ?>:</td>
		<td valign="top" width="60%"><?php 
			if (!isset($deleteComments) || ('N' != $deleteComments && 'Y' != $deleteComments))
			{
				$deleteComments = 'N';
			}
			?><input type="radio" name="deleteComments" id="deleteComments_N" value="N" <?php if ($deleteComments=="N") echo "checked";?>> <label for="deleteComments_N"><?php  echo GetMessage("CML_S_NO"); ?></label><br>
			<input type="radio" name="deleteComments" id="deleteComments_Y" value="Y" <?php if ($deleteComments=="Y") echo "checked";?>> <label for="deleteComments_Y"><?php  echo GetMessage("CML_S_YES"); ?></label>
		</td>
	</tr>
	<tr>
		<td valign="top" width="40%"><?php  echo GetMessage("CML_S_FDEB") ?>:</td>
		<td valign="top" width="60%"><?php 
			if (!isset($cmlDebug) || ('N' != $cmlDebug && 'Y' != $cmlDebug))
			{
				$cmlDebug = 'N';
			}
			?><input type="radio" name="cmlDebug" id="cmlDebug_N" value="N" <?php if ($cmlDebug=="N") echo "checked";?>> <label for="cmlDebug_N"><?php  echo GetMessage("CML_S_NO"); ?></label><br>
			<input type="radio" name="cmlDebug" id="cmlDebug_Y" value="Y" <?php if ($cmlDebug=="Y") echo "checked";?>> <label for="cmlDebug_Y"><?php  echo GetMessage("CML_S_YES"); ?></label>
		</td>
	</tr>
	<tr>
		<td valign="top" width="40%"><?php  echo GetMessage("CML_S_MEMDEB"); ?>:</td>
		<td valign="top" width="60%"><?php 
			if (!isset($cmlMemoryDebug) || ('N' != $cmlMemoryDebug && 'Y' != $cmlMemoryDebug))
			{
				$cmlMemoryDebug = 'N';
			}
			?><input type="radio" name="cmlMemoryDebug" id="cmlMemoryDebug_N" value="N" <?php if ($cmlMemoryDebug=="N") echo "checked";?>> <label for="cmlMemoryDebug_N"><?php  echo GetMessage("CML_S_NO"); ?></label><br>
			<input type="radio" name="cmlMemoryDebug" id="cmlMemoryDebug_Y" value="Y" <?php if ($cmlMemoryDebug=="Y") echo "checked";?>> <label for="cmlMemoryDebug_Y"><?php  echo GetMessage("CML_S_YES"); ?></label>
		</td>
	</tr>
	<tr>
