...
<tr>
	...
	if ($intCountSelected)
	{
		foreach ($V as &$oneKey)
		{
			?><input type="hidden" value="<?php  echo intval($oneKey); ?>" name="V[]" id="oldV<?php  echo intval($oneKey); ?>"><?php 
		}
	}
	?><div id="tree"></div>
	<script type="text/javascript">
...
<tr>
	...
	<td width="60%">
		...
		<input type="hidden" id="XML_DATA" name="XML_DATA" value="<?php  echo (strlen($XML_DATA) > 0 ? $XML_DATA : ''); ?>" />
	</td>
</tr>
<tr>
	<td width="40%"><?php echo GetMessage("CET_SERVER_NAME");?></td>
	<td width="60%">
		<input type="text" name="SETUP_SERVER_NAME" value="<?php echo (strlen($SETUP_SERVER_NAME)>0) ? htmlspecialcharsbx($SETUP_SERVER_NAME) : '' ?>" size="50" /> <input type="button" onclick="this.form['SETUP_SERVER_NAME'].value = window.location.host;" value="<?php echo htmlspecialcharsbx(GetMessage('CET_SERVER_NAME_SET_CURRENT'))?>" />
	</td>
</tr>
<tr>
	<td width="40%"><?php echo GetMessage("CET_SAVE_FILENAME");?></td>
	<td width="60%">
		<b><?php  echo htmlspecialcharsbx(COption::GetOptionString("catalog", "export_default_path", "/bitrix/catalog_export/"));?></b><input type="text" name="SETUP_FILE_NAME" value="<?php echo (strlen($SETUP_FILE_NAME)>0) ? htmlspecialcharsbx($SETUP_FILE_NAME) : "ebay_product_feed_".mktime().".xml" ?>" size="50" />
	</td>
</tr>
<?php 
