			...
			?>
				<div class="content-item">
					<div class="content-avatar">
						<?php  if (strlen($v["IMAGE_FILE"]["SRC"]) > 0):?>
					...
					<div class="content-info">
						...
						<?php if ($v["UserFieldsMain"]["SHOW"] == "Y"):?>
							...
							<?php if($fieldName == 'DATE_REGISTER'):?><div class="content-date"><?= GetMessage("SONET_IN_SITE") ?> <?=FormatDate("Q", MakeTimeStamp($arUserField["VALUE"]))?></div><?php endif;?><?php if($fieldName == 'PERSONAL_CITY'):?><div class="content-city"><?php endif;?>
								<?php if (StrLen($arUserField["VALUE"]) > 0 && $fieldName != 'LAST_LOGIN' && $fieldName != 'DATE_REGISTER'):?>
									<div><?php if($fieldName != 'PERSONAL_CITY'):?><?= $arUserField["NAME"] ?>: <?php endif;?><?= $arUserField["VALUE"] ?></div>
								<?php endif;?>
							<?php if($fieldName == 'PERSONAL_CITY'):?></div><?php endif;?>
							<?php endforeach;?>
						<?php endif;?>
