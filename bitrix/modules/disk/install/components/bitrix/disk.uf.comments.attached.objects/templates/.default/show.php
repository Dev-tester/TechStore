...
?><div id="disk-attached-objects-block-<?=$arResult['UID']?>" class="feed-com-files diskuf-files-entity"><?php 
				...
				<span class="feed-com-file-name-wrap">
					...
					?><script type="text/javascript">
						...
						BX.Disk.Files['<?= $file['ID'] ?>'] = [
							...
							<?php  if($file['EDITABLE'] && $file['CAN_UPDATE']){ ?>
							...
							<?php  } ?>
							<?php  if($file['FROM_EXTERNAL_SYSTEM'] && $file['CAN_UPDATE']){ ?>
	...
	?>
	<?php  if((count($arResult['FILES']) + count($arResult['IMAGES'])) > 1 && $arResult['ENABLED_MOD_ZIP']){ ?>
