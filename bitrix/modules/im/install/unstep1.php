...
<form action="<?php echo $APPLICATION->GetCurPage()?>">
	...
	<p><?php echo GetMessage("MOD_UNINST_SAVE_EMAIL")?></p>
	<p><input type="checkbox" name="saveemails" id="saveemails" value="Y" checked><label for="saveemails"><?php echo GetMessage("MOD_UNINST_SAVE_EMAILS")?></label></p>
