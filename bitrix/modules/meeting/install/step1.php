...
<form action="<?php echo $APPLICATION->GetCurPage()?>" name="form1" method="post">
	...
	<p><input type="checkbox" name="install_public" id="install_public" value="Y"<?=$bChecked ?  ' checked="checked"' : ''?> /><label for="install_public"><?php echo GetMessage("MEETING_INSTALL_PUBLIC")?></label></p>
