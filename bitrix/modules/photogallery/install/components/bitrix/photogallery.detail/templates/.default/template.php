	...
	<div class="photo-detail-image">
		<div class="photo-detail-photo">
			<div class="photo-detail-img">
				<a rel="nofollow" href="<?=$arResult["SLIDE_SHOW"]?>" <?php 
...
?>
		...
		<div class="photo-controls photo-controls-photo">
			...
			<?php if (!empty($arResult["SLIDE_SHOW"])):?>
		...
		<?php if (!empty($arResult["ELEMENT"]["REAL_PICTURE"]["SRC"])):
...
?>
		...
		<?php if (!empty($arResult["ELEMENT"]["EDIT_URL"])):?>
		...
		<?php if (!empty($arResult["ELEMENT"]["DROP_URL"])):?>
			<li class="photo-control photo-control-photo-original">
