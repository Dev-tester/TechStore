...
?>
<tr valign="top">
	<td><?php echo GetMessage("CRM_MAIL_MAIL")?>:</td>
	<td valign="top">
		<?=COption::GetOptionString('crm', 'mail', ''); ?>	
	</td>
</tr>
<tr class="heading">
	<td colspan="2"><?php echo GetMessage("CRM_ENTITY_REGEXP")?><br>
	<?php echo GetMessage("CRM_ENTITY_REGEXP_NOTES")?></td>
</tr>
<tr valign="top">
	<td><?php echo GetMessage("CRM_MAIL_ENTITY_LEAD")?></td>
	<td valign="top">
...
<tr valign="top">
	<td><?php echo GetMessage("CRM_MAIL_ENTITY_CONTACT")?></td>
	<td valign="top">
...
<tr valign="top">
	<td><?php echo GetMessage("CRM_MAIL_ENTITY_COMPANY")?></td>
	<td valign="top">
...
<tr valign="top">
	<td><?php echo GetMessage("CRM_MAIL_ENTITY_DEAL")?></td>
	<td valign="top">
