...
<div class="crm-onec-wrapper">
	<div class="crm-onec-section">
				...
				<div class="crm-onec-header-futures-container">
					<div class="crm-onec-header-futures-block">
						<span class="crm-onec-header-futures">
							...
							<span class="crm-onec-header-futures-text"><?=Loc::getMessage("CRM_1C_START_REALTIME_ADV_1")?></span>
						</span>
					</div>
					<div class="crm-onec-header-futures-block">
						<span class="crm-onec-header-futures">
							<span class="crm-onec-header-futures-icon icon-2"></span>
							<span class="crm-onec-header-futures-text"><?=Loc::getMessage("CRM_1C_START_REALTIME_ADV_2")?></span>
						</span>
					</div>
					<div class="crm-onec-header-futures-block">
						<span class="crm-onec-header-futures">
							<span class="crm-onec-header-futures-icon icon-3"></span>
							<span class="crm-onec-header-futures-text"><?=Loc::getMessage("CRM_1C_START_REALTIME_ADV_3")?></span>
						</span>
					</div>
				</div>
		...
		<div id="b24-integration-active" class="crm-onec-button">
			<div class="ui-btn ui-btn-primary" onclick="window.open('https://www.1c-bitrix.ru/download/1c/handle/Bitrix24_module_installer.epf')">
				<?=GetMessage("CRM_1C_START_REALTIME_DOWNLOAD")?>
			</div>
			<div class="ui-btn ui-btn-default" id="b24-integration-active-button">
				<?=GetMessage("CRM_1C_START_REALTIME_DO_START")?>
			</div>
