...
<div class="crm-task-list-call">
	<div class="crm-task-list-call-info">
		...
		<?php endif?>
		<?php if (!empty($arResult['recipientName']) && !empty($arResult['recipientUrl'])):?>
			<div class="crm-task-list-call-info-container">
		...
		<?php endif?>
		<?php if ($smsMessage && isset($smsMessage['MESSAGE_TO'])):?>
		<div class="crm-task-list-call-info-container">
		...
		<?php endif;?>
		<?php if ($smsMessage && isset($smsMessage['STATUS_ID']) && isset($statuses[$smsMessage['STATUS_ID']])):?>
			<div class="crm-task-list-call-info-container">
				...
				<span class="crm-task-list-call-info-item"><?=htmlspecialcharsbx($statuses[$smsMessage['STATUS_ID']])?>
					<?php if ($arResult['SMS_MESSAGE_STATUS_IS_ERROR'] && !empty($smsMessage['EXEC_ERROR']))
					{
