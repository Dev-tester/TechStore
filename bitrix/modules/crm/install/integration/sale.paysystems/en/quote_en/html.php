...
<?php if (CSalePaySystemAction::GetParamValue('QUOTE_EN_HEADER_SHOW') == 'Y'):?>
<table class="header">
	<tr><?php 
...
<?php if (CSalePaySystemAction::GetParamValue('QUOTE_EN_SIGN_SHOW') == 'Y'):?>
	<?php  if (!$blank) { ?>
