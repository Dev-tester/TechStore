...
$MESS['CRM_SOCCL_TERMINATE'] = "Завершен по смене статуса";
$MESS['CRM_SOCCL_STATUS_NAME'] = "Статус отмены";
$MESS['CRM_SOCCL_STATUS_ERROR'] = "Не указан статус отмены";
$MESS['CRM_SOCCL_COMMENT_NAME'] = "Причина отмены заказа";
?>