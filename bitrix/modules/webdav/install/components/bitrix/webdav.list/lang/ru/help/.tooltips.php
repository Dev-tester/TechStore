...
$MESS ['DOCS_COUNT_TIP'] = "Указывается количество элементов, которые будут выведены на одной странице.";
$MESS ['SORT_BY1_TIP'] = "В списке перечислены поля, по которым может проводиться сортировка документов. Также можно выбрать пункт <i>другое</i> и задать в поле рядом код нужного поля.";
$MESS ['SORT_ORDER1_TIP'] = "По возрастанию либо по убыванию.";
$MESS ['SORT_BY2_TIP'] = "В списке перечислены поля, по которым может проводиться вторая сортировка документов в случае совпадения значений полей первой сортировки. Также можно выбрать пункт <i>другое</i> и задать в поле рядом код нужного поля.";
...
$MESS ['DETAIL_URL_TIP'] = "Указывается шаблон ссылки на страницу детального просмотра. Например, doc_detail.php?ID=#ELEMENT_ID#";
...
$MESS ['PAGER_TITLE_TIP'] = "В данном поле указывается название категорий, по которым происходит перемещение по списку (например, документы, файлы и др.)";
