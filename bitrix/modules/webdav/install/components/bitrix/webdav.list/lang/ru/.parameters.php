...
$MESS ['T_IBLOCK_DESC_IBORD1'] = "Поле для первой сортировки документов";
$MESS ['T_IBLOCK_DESC_IBBY1'] = "Направление для первой сортировки документов";
$MESS ['T_IBLOCK_DESC_IBORD2'] = "Поле для второй сортировки документов";
$MESS ['T_IBLOCK_DESC_IBBY2'] = "Направление для второй сортировки документов";
...
$MESS ['T_IBLOCK_DESC_LIST_CONT'] = "Количество документов на странице";
...
$MESS ['T_IBLOCK_DESC_DOCS_PANEL'] = "Добавлять в админ. панель кнопки для данного компонента";
$MESS ['IBLOCK_FIELD'] = "Поля";
$MESS ['T_IBLOCK_DESC_ACTIVE_DATE_FORMAT'] = "Формат показа даты";
$MESS ['T_IBLOCK_DESC_PAGER_DOCS'] = "Новости";
