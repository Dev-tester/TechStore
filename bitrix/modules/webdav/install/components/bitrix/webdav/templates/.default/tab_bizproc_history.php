...
ob_start();
$result = $APPLICATION->IncludeComponent("bitrix:bizproc.document.history", "webdav.bizproc.document.history", Array(
    "MODULE_ID" => MODULE_ID,
    "ENTITY" => ENTITY,
...
if ($result !== false)
{
	...
	$this->__component->arResult['TABS'][] = 
		array( "id" => $sTabName, 
		"name" => GetMessage("WD_HIST_ELEMENT") . ($historyLength > 0 ? " (".$historyLength.")" : ""), 
