...
/*		"PICTURE" => array(
	...
	"PARAMETERS" => array(
		...
		*/
		...
		"UPDATE_LOGIN" => array(
			"PARENT" => "ADDITIONAL",
			"NAME" => GetMessage("CP_BCI1_UPDATE_LOGIN"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		...
		"UPDATE_PASSWORD" => array(
			"PARENT" => "ADDITIONAL",
			"NAME" => GetMessage("CP_BCI1_UPDATE_PASSWORD"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		...
		"UPDATE_EMAIL" => array(
			"PARENT" => "ADDITIONAL",
			"NAME" => GetMessage("CP_BCI1_UPDATE_EMAIL"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		*/
