		...
		<table class="post-dialog-success-table">
			<tr>
				<td class="post-dialog-success-cell">
					...
					<a href="<?=$arParams['PATH_TO_MAIL_CFG_HOME'] ?>" target="_blank" class="webform-button webform-button-create">
					...
					<a href="<?=$arParams['PATH_TO_MAIL_CONFIG'] ?>" class="webform-button webform-button">
