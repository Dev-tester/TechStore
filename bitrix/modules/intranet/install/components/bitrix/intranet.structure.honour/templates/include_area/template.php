...
?>
	<div class="bx-user-info">
		<div class="bx-user-info-inner">
			...
			<div class="bx-user-subtitle"><?php echo (!empty($arUser['PREVIEW_TEXT_TYPE']) && $arUser['PREVIEW_TEXT_TYPE'] == 'html' ? $arUser['SUBTITLE'] : htmlspecialcharsbx($arUser['SUBTITLE']))?></div>
