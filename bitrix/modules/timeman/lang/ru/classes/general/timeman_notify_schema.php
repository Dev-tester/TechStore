...
$MESS["TIMEMAN_NS_ENTRY"] = "Добавление рабочего отчета";
$MESS["TIMEMAN_NS_ENTRY_COMMENT"] = "Комментарии к рабочему отчету";
$MESS["TIMEMAN_NS_ENTRY_APPROVE"] = "Подтверждение/отмена подтверждения рабочего отчета";
?>