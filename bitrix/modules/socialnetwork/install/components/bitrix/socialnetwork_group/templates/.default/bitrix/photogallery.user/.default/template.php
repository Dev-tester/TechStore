...
?><div class="photo-user photo-user-my"><?php 
...
if ($arParams["PERMISSION"] >= "W"):
	...
	?><a href="<?=($bIsMine ? $arResult["MY_GALLERY"]["LINK"]["UPLOAD"] : $arResult["GALLERY"]["LINK"]["UPLOAD"])?>" class="photo-action photo-upload"><?=GetMessage("P_UPLOAD")?></a><?php 
endif;	
	?></div>
</div>
...
?><div class="photo-controls photo-action"><?php 
	?><a href="<?=htmlspecialcharsbx($APPLICATION->GetCurPageParam("auth=yes&backurl=".$arResult["backurl_encode"], 
		...
		?>" class="photo-action authorize" title="<?=GetMessage("P_LOGIN_TITLE")?>"><?=GetMessage("P_LOGIN")?></a><?php 
?></div>
<div class="empty-clear"></div>
<?php 
endif;
