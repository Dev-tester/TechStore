...
?>
	...
	<ul>
		...
		{
			?>
			<li><a href="<?=$arResult["urlToDraft"]?>"  title="<?=GetMessage("BLOG_MENU_DRAFT_MESSAGES_TITLE")?>"><?=GetMessage("BLOG_MENU_DRAFT_MESSAGES")?><?php if(IntVal($arResult["CntToDraft"]) > 0 ) echo " (".$arResult["CntToDraft"].")"?></a></li>
		...
		{
			?>
			<li><a href="<?=$arResult["urlToModeration"]?>"  title="<?=GetMessage("BLOG_MENU_MODERATION_MESSAGES_TITLE")?>"><?=GetMessage("BLOG_MENU_MODERATION_MESSAGES")?><?php if(IntVal($arResult["CntToModerate"]) > 0 ) echo " (".$arResult["CntToModerate"].")"?></a></li>
