...
<span class="ilike-light">
	<span class="bx-ilike-button <?=($arResult['VOTE_AVAILABLE'] == 'Y'? '': 'bx-ilike-button-disable')?>" id="bx-ilike-button-<?=CUtil::JSEscape(htmlspecialcharsbx($arResult['VOTE_ID']))?>">
		...
		<?php if($arResult['VOTE_AVAILABLE'] == 'Y'):?><span class="bx-ilike-text"><?=($arResult['USER_HAS_VOTED'] == 'N'? GetMessage('RATING_LIKE_N'): GetMessage('RATING_LIKE_Y'))?></span><?php endif;?></span>
	</span>
...
<?php $APPLICATION->AddHeadScript("/bitrix/js/main/rating_like.js");?>
