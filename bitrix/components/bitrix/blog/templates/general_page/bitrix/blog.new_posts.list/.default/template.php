					...
					<?php if(!empty($CurPost["arImages"]))
					{
						...
						<div class="feed-com-files">
							...
							<div class="feed-com-files-cont">
								...
								{
									?><span class="feed-com-files-photo"><a href="<?=$val["full"]?>"<?php /* onclick="ImgShw('<?=CUtil::JSEscape($val["full"])?>', 800, 800); return false;"*/?> target="_blank"><img src="<?=$val["small"]?>" alt="" border="0"></a></span><?php 
								}
								?>
							</div>
						</div>
