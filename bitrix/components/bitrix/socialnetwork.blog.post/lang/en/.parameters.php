<?php 
$MESS["BP_PATH_TO_BLOG"] = "Conversations page path template";
$MESS["BP_PATH_TO_BLOG_CATEGORY"] = "Tag-filtered conversations page path template";
$MESS["BP_PATH_TO_POST_EDIT"] = "Conversation edit page path template";
$MESS["BP_PATH_TO_USER"] = "User profile path template";
$MESS["BP_POST_VAR"] = "Conversation ID variable name";
$MESS["BP_USER_VAR"] = "User ID variable name";
$MESS["BP_PAGE_VAR"] = "Page variable name";
$MESS["BP_SET_NAV_CHAIN"] = "Add item to breadcrumbs";
$MESS["BP_ID"] = "Conversation ID";
$MESS["POST_PROPERTY"] = "Show conversation properties";
