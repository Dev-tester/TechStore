		...
		<div class="col-sm-3">
			<div class="bx-original-item-container">
				...
				<div>
					...
					<?php if (!($arResult["ELEMENT"]["PRICE_VALUE"] == $arResult["ELEMENT"]["PRICE_DISCOUNT_VALUE"])):?><span class="bx-catalog-set-item-price-old"><strong><?=$arResult["ELEMENT"]["PRICE_PRINT_VALUE"]?></strong></span><?php endif?>
								...
								>
									<div class="bx-catalog-set-item">
										...
										<div class="bx-catalog-set-item-add-btn">
											...
											if ($arItem['CAN_BUY'])
											{
												?><a href="javascript:void(0)" data-role="set-add-btn" class="btn btn-default btn-sm"><?=GetMessage("CATALOG_SET_BUTTON_ADD")?></a><?php 
											}
											else
											{
												?><span class="bx-catalog-set-item-notavailable"><?=GetMessage('CATALOG_SET_MESS_NOT_AVAILABLE');?></span><?php 
											}
											?>
										</div>
									</div>
