...
'</div></div>';
	...
	{
		?><?php  echo $arResult["NAV_STRING"]; ?><?php 
	}

	$strElementEdit = CIBlock::GetArrayByID($arParams["IBLOCK_ID"], "ELEMENT_EDIT");
	$strElementDelete = CIBlock::GetArrayByID($arParams["IBLOCK_ID"], "ELEMENT_DELETE");
	$arElementDeleteParams = array("CONFIRM" => GetMessage('CT_BCS_TPL_ELEMENT_DELETE_CONFIRM'));
?><div class="bx_catalog_list_home col<?php  echo $arParams['LINE_ELEMENT_COUNT']; ?> <?php  echo $templateData['TEMPLATE_CLASS']; ?>">
...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="<?php  echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"><div class="bx_catalog_item_container" id="<?php  echo $strMainID; ?>">
		<a id="<?php  echo $arItemIDs['PICT']; ?>" href="<?php  echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images" style="background-image: url('<?php  echo $arItem['PREVIEW_PICTURE']['SRC']; ?>')" title="<?php  echo $imgTitle; ?>"><?php 
	...
	{
	?>
			<div id="<?php  echo $arItemIDs['STICKER_ID']; ?>" class="bx_stick average left top" title="<?php  echo $arItem['LABEL_VALUE']; ?>"><?php  echo $arItem['LABEL_VALUE']; ?></div>
	<?php 
	}
	?>
		</a><?php 
	if ($arItem['SECOND_PICT'])
	{
		...
		{
		?>
			<div id="<?php  echo $arItemIDs['SECOND_STICKER_ID']; ?>" class="bx_stick average left top" title="<?php  echo $arItem['LABEL_VALUE']; ?>"><?php  echo $arItem['LABEL_VALUE']; ?></div>
		<?php 
		}
		?>
		</a><?php 
	...
	<div class="bx_catalog_item_price"><div id="<?php  echo $arItemIDs['PRICE']; ?>" class="bx_price"><?php 
	if (!empty($minPrice))
	{
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		{
			?><div id="<?php  echo $arItemIDs['NOT_AVAILABLE_MESS']; ?>" class="bx_catalog_item_controls_blockone"><span class="bx_notavailable"><?php 
...
var <?php  echo $strObName; ?> = new JCCatalogSection(<?php  echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
</script><?php 
	}
	else
	{
		...
		<div class="bx_catalog_item_controls_blockone">
			...
			?>
		<div id="<?php  echo $arItemIDs['NOT_AVAILABLE_MESS']; ?>" class="bx_catalog_item_controls_blockone" style="display: <?php  echo ($canBuy ? 'none' : ''); ?>;"><span class="bx_notavailable"><?php 
			echo ('' != $arParams['MESS_NOT_AVAILABLE'] ? $arParams['MESS_NOT_AVAILABLE'] : GetMessage('CT_BCS_TPL_MESS_PRODUCT_NOT_AVAILABLE'));
		?></span></div>
...
<script type="text/javascript">
BX.message({
	BTN_MESSAGE_BASKET_REDIRECT: '<?php  echo GetMessageJS('CT_BCS_CATALOG_BTN_MESSAGE_BASKET_REDIRECT'); ?>',
	BASKET_URL: '<?php  echo $arParams["BASKET_URL"]; ?>',
	ADD_TO_BASKET_OK: '<?php  echo GetMessageJS('ADD_TO_BASKET_OK'); ?>',
	TITLE_ERROR: '<?php  echo GetMessageJS('CT_BCS_CATALOG_TITLE_ERROR') ?>',
	TITLE_BASKET_PROPS: '<?php  echo GetMessageJS('CT_BCS_CATALOG_TITLE_BASKET_PROPS') ?>',
	TITLE_SUCCESSFUL: '<?php  echo GetMessageJS('ADD_TO_BASKET_OK'); ?>',
	BASKET_UNKNOWN_ERROR: '<?php  echo GetMessageJS('CT_BCS_CATALOG_BASKET_UNKNOWN_ERROR') ?>',
	BTN_MESSAGE_SEND_PROPS: '<?php  echo GetMessageJS('CT_BCS_CATALOG_BTN_MESSAGE_SEND_PROPS'); ?>',
	BTN_MESSAGE_CLOSE: '<?php  echo GetMessageJS('CT_BCS_CATALOG_BTN_MESSAGE_CLOSE') ?>',
	BTN_MESSAGE_CLOSE_POPUP: '<?php  echo GetMessageJS('CT_BCS_CATALOG_BTN_MESSAGE_CLOSE_POPUP'); ?>',
	COMPARE_MESSAGE_OK: '<?php  echo GetMessageJS('CT_BCS_CATALOG_MESS_COMPARE_OK') ?>',
	COMPARE_UNKNOWN_ERROR: '<?php  echo GetMessageJS('CT_BCS_CATALOG_MESS_COMPARE_UNKNOWN_ERROR') ?>',
	COMPARE_TITLE: '<?php  echo GetMessageJS('CT_BCS_CATALOG_MESS_COMPARE_TITLE') ?>',
	BTN_MESSAGE_COMPARE_REDIRECT: '<?php  echo GetMessageJS('CT_BCS_CATALOG_BTN_MESSAGE_COMPARE_REDIRECT') ?>',
