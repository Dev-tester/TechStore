...
<div class="bx-newsdetail">
	<div class="bx-newsdetail-block" id="<?php echo $this->GetEditAreaId($arResult['ID'])?>">
	...
	<?php if($arParams["DISPLAY_PICTURE"]!="N"):?>
		<?php if ($arResult["VIDEO"]):?>
			<div class="bx-newsdetail-youtube embed-responsive embed-responsive-16by9" style="display: block;">
				<iframe src="<?php echo $arResult["VIDEO"]?>" frameborder="0" allowfullscreen=""></iframe>
			</div>
		<?php elseif ($arResult["SOUND_CLOUD"]):?>
			<div class="bx-newsdetail-audio">
				<iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=<?php echo urlencode($arResult["SOUND_CLOUD"])?>&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
			</div>
		<?php elseif ($arResult["SLIDER"] && count($arResult["SLIDER"]) > 1):?>
			<div class="bx-newsdetail-slider">
				<div class="bx-newsdetail-slider-container" style="width: <?php echo count($arResult["SLIDER"])*100?>%;left: 0%;">
					<?php foreach ($arResult["SLIDER"] as $file):?>
					<div style="width: <?php echo 100/count($arResult["SLIDER"])?>%;" class="bx-newsdetail-slider-slide">
	...
	<?php if($arParams["DISPLAY_DATE"]!="N" && $arResult["DISPLAY_ACTIVE_FROM"]):?>
		<div class="bx-newsdetail-date"><i class="fa fa-calendar-o"></i> <?php echo $arResult["DISPLAY_ACTIVE_FROM"]?></div>
	<?php endif?>
