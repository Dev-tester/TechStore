...
if (!empty($arResult['ITEMS']))
{
	...
	<?php  if(empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] == 'N'){ ?><div class="bx_item_list_title"><?php  echo ($arParams['BLOCK_TITLE']? htmlspecialcharsbx($arParams['BLOCK_TITLE']) : GetMessage('SGP_TPL_BLOCK_TITLE_DEFAULT')) ?></div><?php  } ?>
	...
	?>
		<script type="text/javascript">
			var <?php  echo $strObName; ?> = new JCSaleGiftProduct(<?php  echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
		</script><?php 
	}
	else // Wth Sku
	{
