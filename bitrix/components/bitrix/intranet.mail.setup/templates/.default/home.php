...
<?php  $isUserAdmin = $USER->isAdmin() || $USER->canDoOperation('bitrix24_config'); ?>

<?php  $showB24Block = IsModuleInstalled('bitrix24') && !empty($b24Settings) && !empty($arParams['CR_DOMAINS']); ?>
<?php  $showDomainBlock = IsModuleInstalled('bitrix24') || !empty($domainSettings) || in_array(LANGUAGE_ID, array('ru', 'ua')); ?>

<?php  $b24Mailbox = !empty($b24Settings) && !empty($arParams['MAILBOX']) && $arParams['MAILBOX']['SERVICE_ID'] == $b24Settings['id']; ?>
<?php  $domainMailbox = !empty($domainSettings) && !empty($arParams['MAILBOX']) && $arParams['MAILBOX']['SERVICE_ID'] == $domainSettings['id']; ?>
<?php  $imapMailbox = !empty($arParams['MAILBOX']) && $arParams['MAILBOX']['SERVER_TYPE'] == 'imap'; ?>
