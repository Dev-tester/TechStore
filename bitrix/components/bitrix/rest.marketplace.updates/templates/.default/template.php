...
<?php
		...
		if($app['CAN_INSTALL']):
?>
				<a class="bt_green" href="javascript:void(0)" onclick="BX.rest.Marketplace.install(<?php echo CUtil::PhpToJSObject($arParamsApp)?>);"><?=GetMessage("MARKETPLACE_UPDATE_BUTTON")?></a>
<?php
		else:
?>
