...
<div title="<?=Loc::getMessage('SALE_SDRR_INCEDENT_TITLE')?>" title="<?=Loc::getMessage('SALE_SDRR_INCEDENT_TITLE')?>">
	<?php if($arResult['RELIABILITY'] == \Sale\Handlers\Delivery\Additional\RusPost\Reliability\Service::RELIABLE):?>
        <span class="sale-ruspost-reliability-reliable"><?=Loc::getMessage('SALE_SDRR_INCEDENT_NOT_HAPPEND')?></span>
	<?php elseif($arResult['RELIABILITY'] == \Sale\Handlers\Delivery\Additional\RusPost\Reliability\Service::FRAUD):?>
