...
$MESS ['WD_TITLE'] = "Изменение документа";
$MESS ['WD_TITLE_CLONE'] = "Создание версии документа";
$MESS ['WD_ACCESS_DENIED'] = "Доступ запрещен.";
$MESS ['WD_ERROR_ELEMENT_LOCKED'] = "Запись временно заблокирована пользователем #ID# (#DATE#).";
