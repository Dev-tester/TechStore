...
class BitrixVmStep  extends \CWizardStep
{
	...
	public function showStep()
	{
		...
		<div class="adm-bsm-site-master-paragraph"><?=Loc::getMessage("SALE_BSM_WIZARD_BITRIXVMSTEP_VM_LINK_DOWNLOAD")?></div>
		<div class="adm-bsm-site-master-paragraph"><?=Loc::getMessage("SALE_BSM_WIZARD_BITRIXVMSTEP_VM_LINK_DOC")?></div>
		<?php
