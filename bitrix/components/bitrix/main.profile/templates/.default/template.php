...
<p><input type="submit" name="code_submit_button" value="<?php echo GetMessage("main_profile_send")?>" /></p>
...
<table class="profile-table data-table">
	...
	<tr>
		...
		<td><input type="text" name="LOGIN" maxlength="50" value="<?php  echo $arResult["arUser"]["LOGIN"]?>" /></td>
	</tr>
	<tr>
		<td><?=GetMessage('EMAIL')?><?php if($arResult["EMAIL_REQUIRED"]):?><span class="starrequired">*</span><?php endif?></td>
		<td><input type="text" name="EMAIL" maxlength="50" value="<?php  echo $arResult["arUser"]["EMAIL"]?>" /></td>
	</tr>
<?php if($arResult["PHONE_REGISTRATION"]):?>
	<tr>
		...
		<td><input type="text" name="PHONE_NUMBER" maxlength="50" value="<?php  echo $arResult["arUser"]["PHONE_NUMBER"]?>" /></td>
	</tr>
<?php endif?>
...
<table class="data-table profile-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><textarea cols="30" rows="5" class="typearea" name="blog_INTERESTS"><?php echo $arResult["arBlogUser"]["INTERESTS"]; ?></textarea></td>
		</tr>
		<tr>
