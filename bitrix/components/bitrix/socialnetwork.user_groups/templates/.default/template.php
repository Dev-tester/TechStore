	...
	?><div id="sonet-groups-content-wrap" class="sonet-groups-content-wrap<?=(!$notEmptyList ? " no-groups" : "")?>">
		<div class="sonet-groups-content-sort-container"><?php 
			?><span id="bx-sonet-groups-sort"><?php 
				...
				?><span class="sonet-groups-content-sort-btn" id="bx-sonet-groups-sort-value"><?=GetMessage('SONET_C33_T_F_SORT_'.strtoupper($arResult["ORDER_KEY"]))?></span><?php 
			?></span><?php 
				...
				if ($notEmptyList)
				{
					...
					foreach ($arResult["Groups"]["List"] as $group)
					{
						...
						?><div class="sonet-groups-group-block"><?php 
							?><span class="sonet-groups-group-img"<?=($group["GROUP_PHOTO_RESIZED_COMMON"] ? " style=\"background:#fff url('".$group["GROUP_PHOTO_RESIZED_COMMON"]["src"]."') no-repeat; background-size: cover;\"" : "")?>></span><?php 
							?><span class="sonet-groups-group-text"><?php 
								?><span class="sonet-groups-group-title<?=($group["IS_EXTRANET"] == "Y" ? " sonet-groups-group-title-extranet" : "")?>"><?php 
									...
									?><span title="<?=GetMessage('SONET_C33_T_ACT_FAVORITES_'.($isFav ? 'REMOVE' : 'ADD'))?>" id="bx-sonet-groups-favorites-<?=intval($group['GROUP_ID'])?>" class="sonet-groups-group-title-favorites<?=($isFav ? ' sonet-groups-group-title-favorites-active' : '')?>"></span><?php 
									?><script>
								...
								?></span><?php 
								?><?=(strlen($group["GROUP_DESCRIPTION_FULL"]) > 0 ? '<span class="sonet-groups-group-description">'.$group["GROUP_DESCRIPTION_FULL"].'</span>' : "")?><?php 
								...
								)
								{
									?><span class="sonet-groups-group-btn-container"><?php 
										...
										?><span id="bx-sonet-groups-request-sent-<?=intval($group['GROUP_ID'])?>" class="sonet-groups-group-desc-container<?=($requestSent ? " sonet-groups-group-desc-container-active" : "")?>"><span class="sonet-groups-group-desc-check"></span><?=GetMessage('SONET_C33_T_F_DO_REQUEST_SENT')?></span><?php 
										...
										{
											?><span id="bx-sonet-groups-request-<?=intval($group['GROUP_ID'])?>" class="ui-btn ui-btn-light-border ui-btn-sm"><?=GetMessage('SONET_C33_T_F_DO_REQUEST')?></span><?php 
											?><script>
		...
		?><div class="sonet-sidebar">
			<div class="sonet-groups-sidebar-content">
				...
				<div class="sonet-groups-sidebar-items"><?php 
					...
					{
						?><div class="sonet-groups-group-block"><?php 
							?><span class="sonet-groups-group-img"<?=($group["IMAGE_RESIZED"] ? " style=\"background:#fff url('".$group["IMAGE_RESIZED"]["src"]."') no-repeat; background-size: cover;\"" : "") ?>></span><?php 
							?><span class="sonet-groups-group-text"><?php 
								?><span class="sonet-groups-group-title<?=($group["IS_EXTRANET"] == "Y" ? " sonet-groups-group-title-extranet" : "") ?>"><?php 
									?><a href="<?=$group["URL"]?>" class="sonet-groups-group-link"><?=$group["NAME"] ?></a><?php 
								?></span><?php 
								?><span class="sonet-groups-group-description"><?=(strlen($group["DESCRIPTION"]) > 0 ? $group["DESCRIPTION"] : "&nbsp;") ?></span><?php 
							?></span><?php 
						?></div><?php 
					}
				?></div>
