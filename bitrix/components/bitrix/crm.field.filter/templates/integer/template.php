...
<input type="text" name="<?=$arParams["arUserField"]["FIELD_NAME"]?>_from" value="<?=$res[0]?>" size="8" <?php 	
	if ($arParams["arUserField"]["EDIT_IN_LIST"]!="Y"):
		?> disabled="disabled"<?php 
	endif;
?> class="fields integer" /> ... 
<input type="text" name="<?=$arParams["arUserField"]["FIELD_NAME"]?>_to" value="<?=$res[1]?>" size="8" <?php 		
	if ($arParams["arUserField"]["EDIT_IN_LIST"]!="Y"):
		?> disabled="disabled"<?php 
	endif;
