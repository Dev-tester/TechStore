...
{
		?><select id="TO_SECTION_ID" name="TO_SECTION_ID"><?php 
		foreach ($arResult["SECTION_LIST"] as $key => $val):
			?><option value="<?=$key?>" <?php 
				?> <?=($arResult["ELEMENT"]["IBLOCK_SECTION_ID"] == $key ? "selected" : "")?>><?=$val?></option><?php 
		endforeach;
		?></select><?php 
}
			?>
...
?>
		<div class="photo-edit-field photo-edit-field-public">
			<input type="checkbox" name="PUBLIC_ELEMENT" id="PHOTO_PUBLIC_ELEMENT" value="Y" <?php 
...
?>
		<div class="photo-edit-field photo-edit-field-approve">
			<input type="checkbox" name="APPROVE_ELEMENT" id="PHOTO_APPROVE_ELEMENT" value="Y" <?php 
...
?>
		<div class="photo-edit-field photo-edit-field-active">
			<input type="checkbox" name="ACTIVE" id="PHOTO_ACTIVE" value="Y" <?php 
...
<?php 
	if (IsModuleInstalled("search")):
			...
			?><input type="text" name="TAGS" id="TAGS" value="<?=$arResult["ELEMENT"]["TAGS"]?>" /><?php 
	endif;
?>
		</div>
<?php 
