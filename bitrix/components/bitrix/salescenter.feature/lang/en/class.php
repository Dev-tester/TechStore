...
$MESS["SALESCENTER_LIMITS_MESSAGE"] = "Congratulations! <br />You have created 100 orders using the Live Chat and SMS.<br /><br />Please upgrade to one of the commercial plans to contiune handling orders and receive payments via the Sales Center.";
$MESS["SALESCENTER_LIMITS_TITLE"] = "Available only on selected commercial plans";
?>