...
?>
<tr>
	<td class="bx-filter-caption"><?php echo GetMessage('INTR_ISS_PARAM_DEPARTMENT')?>: </td>
	<td>
<?php if ($arResult['CURRENT_USER']['DEPARTMENT_TOP']):?>
		<input type="checkbox" id="only_mine_office" onclick="BXChangeFilterTop_adv(this)" <?php echo $arResult['FILTER_VALUES'][$arParams['FILTER_NAME'].'_UF_DEPARTMENT'] == $arResult['CURRENT_USER']['DEPARTMENT_TOP'] || $arResult['FILTER_VALUES'][$arParams['FILTER_NAME'].'_UF_DEPARTMENT'] == array($arResult['CURRENT_USER']['DEPARTMENT_TOP']) ? 'checked="checked"' : ''?> />
		<label for="only_mine_office"><?php echo GetMessage('INTR_ISS_PARAM_DEPARTMENT_MINE')?></label><br />
<?php endif;?>
<?php 
...
?>
	<td class="bx-filter-caption"><?php echo GetMessage('INTR_ISS_PARAM_POST')?>: </td>
...
<tr>
	<td class="bx-filter-caption"><?php echo GetMessage('INTR_ISS_PARAM_KEYWORDS')?>: </td>
...
<tr>
	<td colspan="2">
		...
		<input type="submit" name="set_filter_<?=$arParams['FILTER_NAME']?>" value="<?php echo GetMessage('INTR_ISS_BUTTON_SUBMIT')?>" class="bx-submit-btn" /> 
		<input type="submit" name="del_filter_<?=$arParams['FILTER_NAME']?>" value="<?php echo GetMessage('INTR_ISS_BUTTON_CANCEL')?>" class="bx-reset-btn" />
	</td>
</tr>
</tfoot>
</table>
