...
<div id="bxec_add_ed_<?=$id?>" class="bxec-popup" style="width:380px;">
	<?php if(CCalendarSceleton::CheckBitrix24Limits($arParams)):?>
	...
	<?php if($arParams['bIntranet'] && ($arParams['type'] != 'user' || $arParams['inPersonalCalendar'])):?>
		<div class="bxec-popup-row">
	...
	<?php endif;/*if(CCalendarSceleton::CheckBitrix24Limits($arParams))*/?>
</div>