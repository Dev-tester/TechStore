<?php 
$MESS ['MESSAGE_COUNT_TIP'] = "Maximum number of messages displayed on a page.";
$MESS ['MESSAGE_LENGTH_TIP'] = "The number of characters allowed in a single post.";
...
$MESS ['CACHE_TYPE_TIP'] = "<i>Auto</i>: cache is valid for a time period predefined in the cache settings;<br /><i>Cache</i>: always cache for the period specified in the next field;<br /><i>Do not cache</i>: no caching is performed.";
...
$MESS ['MESSAGE_LENGHT_TIP'] = "The number of characters allowed in a single post.";
?>