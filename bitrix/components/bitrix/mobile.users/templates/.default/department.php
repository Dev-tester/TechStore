...
?>
<div id="m-users">
<?php if($_REQUEST["AJAX_CALL"] != "Y")
{
	?><h2><?=$arResult["deps"][$arResult["cur_dep"]]["NAME"]?></h2><?php 
}
			...
			<table width="100%">
				<tr>
					...
					<td style="padding-left: 10px;" width="100%">
						...
						<?php endif;?>
						<b><a href="<?=$item["URL"]?>"<?php if($item["IS_ONLINE"]):?> class="bx-user-online"<?php endif;?>><?=$item["LAST_NAME"].' '.$item['NAME']?></a></b><br />
