	...
	<form method="post" name="form1" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data" role="form">
					...
					if ($arResult['CAN_EDIT_PASSWORD'])
					{
						...
						<div class="form-group row">
							...
							<div class="col-sm-8 col-md-9">
								...
								<small id="emailHelp" class="form-text text-muted"><?php echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></small>
							</div>
						</div>
						<?php 
					}
		...
		<div class="row">
			<div class="col">
				...
				<input type="submit" class="btn btn-themes btn-link btn-md"  name="reset" value="<?php echo GetMessage("MAIN_RESET")?>">
			</div>
		</div>
