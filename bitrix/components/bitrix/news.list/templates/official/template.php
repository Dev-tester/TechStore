...
<tr id="<?=$this->GetEditAreaId($arItem['ID']);?>">
	<td valign="top" width="0%">
		<?php if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
			...
			<?php endif;?>
		<?php elseif(is_array($arItem["DISPLAY_PROPERTIES"]["DOC_TYPE"]) && file_exists($_SERVER['DOCUMENT_ROOT'].$templateFolder."/images/".strtolower($arItem["DISPLAY_PROPERTIES"]["DOC_TYPE"]["VALUE_XML_ID"]).".gif")):?>
