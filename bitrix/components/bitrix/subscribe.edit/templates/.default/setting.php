...
<tr valign="top">
	<td width="40%">
		...
		<label><input type="radio" name="FORMAT" value="text"<?php if($arResult["SUBSCRIPTION"]["FORMAT"] == "text") echo " checked"?> /><?php echo GetMessage("subscr_text")?></label>&nbsp;/&nbsp;<label><input type="radio" name="FORMAT" value="html"<?php if($arResult["SUBSCRIPTION"]["FORMAT"] == "html") echo " checked"?> />HTML</label></p>
	</td>
	<td width="60%">
