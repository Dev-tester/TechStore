...
if(!empty($arResult["INFO_CONNECTION"]))
	...
	<div class="imconnector-social-connected">
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_SKYPE"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_SLACK"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_KIK"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_GROUPME"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_SMS"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_MSTEAMS"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_WEBCHAT"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_EMAIL"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_TELEGRAM"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_FACEBOOK"])):?>
		...
		<?php endif;?>
		<?php if(!empty($arResult["INFO_CONNECTION"]["URL_DIRECTLINE"])):?>
