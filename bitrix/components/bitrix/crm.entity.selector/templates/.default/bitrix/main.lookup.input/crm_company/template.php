...
<div class="mli-layout" id="layout_<?=$control_id?>">
	...
	<textarea name="<?=$textarea_id?>" id="<?=$textarea_id?>"><?php if (isset($arParams['INPUT_VALUE_STRING'])) echo htmlspecialchars($arParams['INPUT_VALUE_STRING']);?></textarea>
	<?php else:?>
	<input autocomplete="off" type="text" name="<?=$textarea_id?>" id="<?=$textarea_id?>" value="<?php if (isset($arParams['INPUT_VALUE_STRING'])) echo htmlspecialchars($arParams['INPUT_VALUE_STRING']);?>">
	<?php endif?>
</div>
<script type="text/javascript">
var jsCES_<?=$control_id?> = new JCMainLookupSelector({
